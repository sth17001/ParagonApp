...
public class addSpecial extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DatabaseReference table_user = database.getReference("SpecialItems");
        ...
        DatabaseReference tool = FirebaseDatabase.getInstance().getReference().child("SpecialItems");
        ...
        addTool.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nameT.getText().toString().equals("")|| priceT.getText().toString().equals("")) {
                    Toast.makeText(addSpecial.this, "Missing a name or price", Toast.LENGTH_SHORT).show();
                }
                else {
                    ...
                    table_user.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            if (dataSnapshot.child(nameT.getText().toString()).exists()) {
                                Toast.makeText(addSpecial.this, "Item already exists", Toast.LENGTH_SHORT).show();
                            }
                            else {
                                Item employee = new Item(nameT.getText().toString(), priceT.getText().toString());
                                table_user.child(count.toString()).setValue(employee);
                                Toast.makeText(addSpecial.this, "New Item added", Toast.LENGTH_SHORT).show();
                                finish();
                            }
                        }
