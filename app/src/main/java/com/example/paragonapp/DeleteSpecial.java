...
public class DeleteSpecial extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delete_special);
        deleteName = "";

        toolListView = (ListView)findViewById(R.id.deleteToolView);

        //Load tools
        tool = FirebaseDatabase.getInstance().getReference().child("SpecialItems");
        tool.addListenerForSingleValueEvent(new ValueEventListener(){
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter = new SimpleAdapter(DeleteSpecial.this, listOfTools, R.layout.listview2, new String[]{"1", "2"}, new int[]{R.id.text1, R.id.text2});
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for(DataSnapshot data: dataSnapshot.getChildren()){
                            if (data.getKey().toString().equals(deleteID)) {
                                ...
                                Toast.makeText(DeleteSpecial.this, "Removed Item "+deleteName, Toast.LENGTH_LONG).show();
                            }
                        }
                    }
