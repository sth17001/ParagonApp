...
public class addGrill extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_grill);
        FirebaseDatabase database = FirebaseDatabase.getInstance();
        final DatabaseReference table_user = database.getReference("GrilledItems");
        ...
        DatabaseReference tool = FirebaseDatabase.getInstance().getReference().child("GrilledItems");
        ...
        addTool.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nameT.getText().toString().equals("")|| priceT.getText().toString().equals("")) {
                    Toast.makeText(addGrill.this, "Missing a name or price", Toast.LENGTH_SHORT).show();
                }
                else {
                    ...
                    table_user.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            if (dataSnapshot.child(nameT.getText().toString()).exists()) {
                                Toast.makeText(addGrill.this, "Item already exists", Toast.LENGTH_SHORT).show();
                            }
                            else {
                                Item employee = new Item(nameT.getText().toString(), priceT.getText().toString());
                                table_user.child(count.toString()).setValue(employee);
                                Toast.makeText(addGrill.this, "New Item added", Toast.LENGTH_SHORT).show();
                                finish();
                            }
                        }
